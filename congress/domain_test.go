...
// HTTP behaviour is covered in congress_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "congress://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("congress", "about")
	if err != nil || got.String() != "congress://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want congress://page/about", got.String(), err)
	}
}
